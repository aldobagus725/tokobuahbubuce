          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  Daftar Pelanggan Bu Buce<br><br>
              ...
              <div class="card-body">
                  <table class="table table-hover">
                      ...
                      <?php
                        $data = mysqli_query($config,"select * from tabel_user where role = 1");
                      ...
                      <tr>
                          ...
                          <td>
                              <a href="edit_pelanggan.php?id=<?php echo $row['id_user']; ?>">EDIT</a>
                              <a href="hapus_pelanggan.php?id=<?php echo $row['id_user']; ?>">HAPUS</a>
                          </td>
                      </tr>
                      <?php 
