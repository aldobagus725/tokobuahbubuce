            ...
            <div class="card">
              ...
              <div class="card-body">
                  <table class="table table-hover">
                      ...
                      <?php
                        $data = mysqli_query($config,"select * from tabel_pegawai");
                      ...
                      <tr>
                          ...
                          <td>
                              <a href="edit_pegawai.php?id=<?php echo $row['id_pegawai']; ?>">EDIT</a>
                              <a href="hapus_pegawai.php?id=<?php echo $row['id_pegawai']; ?>">HAPUS</a>
                          </td>
                      </tr>
                      <?php 
